...
ds_map_add(map,"Poly"+string(ls)+"Face"+string(o)+"Co"+string(2),global.cord1[ls,o]);
ds_map_add(map,"Poly"+string(ls)+"Face"+string(o)+"Co"+string(3),global.cord1[ls,o]);
ds_map_add(map,"Poly"+string(ls)+"Face"+string(o)+"Co"+string(4),global.cord1[ls,o]);
ds_map_add(map,"Poly"+string(ls)+"Face"+string(o)+"Co"+string(5),global.cord1[ls,o]);
ds_map_add(map,"Poly"+string(ls)+"Face"+string(o)+"Co"+string(6),global.cord1[ls,o]);
ds_map_add(map,"Poly"+string(ls)+"Face"+string(o)+"Co"+string(7),global.cord1[ls,o]);
ds_map_add(map,"Poly"+string(ls)+"Face"+string(o)+"Co"+string(8),global.cord1[ls,o]);
ds_map_add(map,"Poly"+string(ls)+"Face"+string(o)+"Co"+string(9),global.cord1[ls,o]);
}
